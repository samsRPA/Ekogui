...
async def run():
    ...
    autosProducer = dependency.autosProducer()
    collProducer = dependency.collProducer()
    ...
    try:
        ...
        await autosProducer.connect()
        await collProducer.connect()
        ...
        await autosProducer.close()
        await collProducer.close()
